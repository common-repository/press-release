...
namespace Prwirepro_press_release_editor\Inc\Admin;
...
class Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/prwirepro-press_release_editor-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'prwirepro_ajax_handle', plugin_dir_url( __FILE__ ) . 'js/prwirepro-press_release_editor-ajax-handler.js', array( 'jquery' ), $this->version, false );				
	...
	public function add_plugin_admin_menu() {
		...
		add_menu_page(	__( 'Press Release Editor', $this->plugin_text_domain ), //page title
						__( 'Press Release Editor', $this->plugin_text_domain ), //menu title
		...
		$html_form_page_hook = add_submenu_page( 
									...
									__( 'Press Release Editor', $this->plugin_text_domain ), //page title
