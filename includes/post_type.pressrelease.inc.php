...
/**
 * Custom Post Types (Pressrelease)
 *
**/

# Exit if accessed directly
if(!defined("PRESSRELEASEEDITOR_EXEC")){
	die();
}


 /**
  * Dispaly front-end for custom post pressrelease
  * 
...
class Pressrelease_TheContent{
	...
	public function __construct(){
		$this->options = get_option("press_release_plugins"); // get current option
	...
	public function Markup($content){
		$new_content = null ;
		//Display file path
		if(PRESSRELEASEEDITOR_DEBUG==true){
			$file_info = null; 
		...
		$new_content .= "<div class=\"pressreleaseeditor-row\">" ; 
		$new_content .= "<div class=\"pressreleaseeditor-col-md-4\">" ; 
		$new_content .= "</div><!-- .//pressreleaseeditor-col-md-4 -->" ; 
		$new_content .= "<div class=\"pressreleaseeditor-col-md-8\">" ; 
		$new_content .= "<dl class=\"pressreleaseeditor-dl-horizontal\">" ; 
		$new_content .= "<dl>" ; 
		$new_content .= "</div><!-- .//pressreleaseeditor-col-md-8 -->" ; 
		$new_content .= "</div><!-- .//pressreleaseeditor-row -->" ; 
		...
		$new_content .= "<div class=\"pressreleaseeditor-panel pressreleaseeditor-panel-default\">" ;
		$new_content .= "<div class=\"pressreleaseeditor-panel-body\">" ;
		$new_content .= $content ;
		$new_content .= "</div>" ;
		$new_content .= "</div>" ;
		return $new_content;
